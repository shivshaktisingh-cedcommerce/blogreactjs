  ...
  return (
    <div id="registermaindiv">
        <div id="registerfirstdiv">
            ...
            <div id="registeruserdiv"><i class="fa fa-user iconregistered" aria-hidden="true" ></i><input type="text" name="name" onChange={register} value={userregistration.name} autoFocus/></div>
            ...
            <div id="registerphonediv"><i class="fa fa-phone iconregistered" aria-hidden="true"></i><input type="text" name="mobile" onChange={register} value={userregistration.mobile} /></div>
        ...
        <div id="registerseconddiv">
            <img src="../1.jpg" alt="" id="registeredpageimage"/>
        </div>
